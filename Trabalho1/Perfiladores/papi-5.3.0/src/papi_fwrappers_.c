...
void papif_add_named_event_ ( int *EventSet, char *EventName, int *check )
...
void papif_get_exe_info_ ( char *fullname, char *name, long long *text_start, long long *text_end, long long *data_start, long long *data_end, long long *bss_start, long long *bss_end, int *check )
...
void papif_get_hardware_info_ ( int *ncpu, int *nnodes, int *totalcpus, int *vendor, char *vendor_string, int *model, char *model_string, float *revision, float *mhz )
...
void papif_query_named_event_ ( char *EventName, int *check )

{
 *check = PAPI_query_named_event( EventName );
}
# 714 "papi_fwrappers.c"
void papif_get_event_info_ ( int *EventCode, char *symbol, char *long_descr, char *short_descr, int *count, char *event_note, int *flags, int *check )
...
void papif_event_code_to_name_ ( int *EventCode, char *out, int *check )
...
void papif_event_name_to_code_ ( char *in, int *out, int *check )
...
void papif_remove_named_event_ ( int *EventSet, char *EventName, int *check )
...
void papif_get_preload_ ( char *lib_preload_env, int *check )
